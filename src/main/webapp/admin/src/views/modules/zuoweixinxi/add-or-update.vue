<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="自习室名称" prop="zixishimingcheng">
          <el-input v-model="ruleForm.zixishimingcheng" 
              placeholder="自习室名称" clearable  :readonly="ro.zixishimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="自习室名称" prop="zixishimingcheng">
              <el-input v-model="ruleForm.zixishimingcheng" 
                placeholder="自习室名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="座位状态" prop="zuoweizhuangtai">
          <el-select :disabled="ro.zuoweizhuangtai" v-model="ruleForm.zuoweizhuangtai" placeholder="请选择座位状态">
            <el-option
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
       ...
       this.ruleForm.zuoweizhuangtai='空'
      }
      // 获取用户信息
      this.$http({
